            ...
            <ul class="nav nav-pills d-inline-flex text-center mb-5">
              ...
              <li class="nav-item">
                <a
                  ...
                  href="#tab-2"
                >
                  <span class="text-dark" style="width: 140px">Rau xanh, rau tươi</span>
                </a>
              </li>
              <li class="nav-item">
                <a
                  ...
                  href="#tab-3"
                >
                  <span class="text-dark" style="width: 120px">Rau củ quả</span>
                </a>
              </li>
              <li class="nav-item">
                <a
                  ...
                  >
                    <div class="rounded position-relative fruite-item">
                      <div class="fruite-img">
                        <router-link
                          :to="{ name: 'DetailComponent', params: { id: product.id } }"
                        >
                          <img
    ...
    <div class="container py-5">
      ...
      <div class="row g-4">
        <div
          ...
          v-for="product in sanPhamMoiNhat"
          :key="product.id"
        >
...
export default {
  ...
  computed: {
    ...
    sanPhamMoiNhat() {
      ...
      // Lọc ra các sản phẩm có ID lớn hơn hoặc bằng 20
      return sortedProducts.filter((product) => product.id > 18);
    },
  },
};
</script>
