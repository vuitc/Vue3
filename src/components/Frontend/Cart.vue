          ...
          <tbody>
            <tr v-for="(cart, index) in allCarts" :key="index">
              ...
              <td>
                ...
                <a
                  class="btn btn-sm btn-plus rounded-circle bg-light border mt-4"
            ...
            <tr>
              <td colspan="6">
                <div class="d-flex justify-content-end">
                  ...
                  <router-link to="/checkout"  class="btn border-secondary rounded-pill px-4 py-3 text-primary text-uppercase mb-4 ms-4">Proceed Checkout</router-link>
                </div>
              </td>
            </tr>
          </tbody>
